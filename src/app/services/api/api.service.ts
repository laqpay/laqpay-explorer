 ...
 * Laqpay node API, but there are differences. There is more info clicking the "Explorer API"
 * link in the main page of the explorer. For even more info, seach the value of the "Internal
 * laqpay node path:" section in the Laqpay REST API docs:
 * https://github.com/laqpay/laqpay/blob/develop/src/api/README.md
 */
@Injectable()
