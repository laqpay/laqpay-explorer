...
The explorer automatically tries to obtain from the node the name of the coins and hours. If, for example, the explorer is connected to a Laqpay node, it will automatically get the "LAQ" name from the node and use it to identify the amounts of coins.
...
contactLinks: [
  {
    url: "https://github.com/laqpay",
    content: "<i class='fab fa-github'></i>",
  },{
    url: "https://t.me/Laqpay",
...
```
{
  url: "https://twitter.com/laqpayproject",
